...
class AllFileViewModel {
    ...
    func cellForRowAt (tableView: UITableView, indexPath: IndexPath) -> UITableViewCell {
        ...
        if file.googleFile[indexPath.item].thumbnailLink == nil {
            UniversalRequest.shared.universalSetImageFromStringrURL(imageView: cell.optionImage, stringURL: file.googleFile[indexPath.item].iconLink!)
        } else {
            UniversalRequest.shared.universalSetImageFromStringrURL(imageView: cell.optionImage, stringURL: file.googleFile[indexPath.item].thumbnailLink!)
        }
        return cell
    }
